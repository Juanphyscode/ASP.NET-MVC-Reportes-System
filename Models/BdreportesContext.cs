...
public partial class BdreportesContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Iidpersona).HasName("PK__Usuarios__6A184103AF073A4D");

            entity.Property(e => e.Iidpersona)
                .ValueGeneratedNever()
                .HasColumnName("IIDPERSONA");
            entity.Property(e => e.Password).HasMaxLength(50);

            entity.HasOne(d => d.IidpersonaNavigation).WithOne(p => p.Usuario)
                .HasForeignKey<Usuario>(d => d.Iidpersona)
